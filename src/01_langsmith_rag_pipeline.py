...
def setup_vectorstore():
    ...
    # Chia thành dưới 100 chunks để phù hợp Gemini embedding free-tier.
    chunks = split_text(text, chunk_size=575, chunk_overlap=50)
...
RAG_PROMPT = ChatPromptTemplate.from_messages([
    (
        "system",
        "Bạn là trợ lý AI hữu ích. Chỉ sử dụng thông tin trong context để trả lời. "
        "Nếu context không đủ thông tin, hãy nói rõ rằng bạn không biết.\n\n"
        "Context:\n{context}",
    ),
    ("human", "{question}"),
])
